# Name: Nathan Edwards
# Pro Purpose: This program computes college tuition & fees based on numbert of credits
#   PVCC Fee Rates are from: https://wwww.pvcc.edu/tuition-and-fees
...
inout = 1 # 1 means in-state, 2 menas out-of0state
numcredits = 0
scholarshipamt = 0
tuitionfee = 0
capitalfee = 0
...
def main():
    ...
    while another_student:
        ...
        display_results()
        yesno = input("/nWould you like to calculate tuition & fees for another student? (Y/N): ")
        if yesno.upper() != "Y":
...
def perform_calculations():
    global tuitionfee, capitalfee, instituitionfee, activityfee, totalowed, balance
    if inout == 1:
...
def display_results():
    ...
    print('Captial Fee       $ ' + str(capitalfee))
